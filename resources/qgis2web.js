...
map.getView().fit([3155622.441744, 5857391.007896, 3251145.715691, 5931448.886540], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Moldova Dumpsites</h2>';
        return titleElement;
    })(),
